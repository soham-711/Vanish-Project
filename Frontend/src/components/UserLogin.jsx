    ...
    >
      ...
      <div className="bg-white/10 backdrop-blur-lg p-8 rounded-xl shadow-lg w-full max-w-md text-white">
        ...
        <form onSubmit={Submit}>
          ...
          {/* Submit Button */}
          <button type="submit" className="w-full py-2 bg-red-600 hover:bg-red-700 rounded-md font-bold">
            Log In
          </button>
        </form>
        ...
        <div className="mt-4 text-center text-sm text-gray-300">
          <button onClick={() => setShowForgotPassword(true)} className="text-red-400 hover:underline">
            Forgot Password?
          </button>
          <p className="mt-2">
            Don&apos;t have an account?{" "}
            <Link to="/user-signup" className="text-red-400 hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
